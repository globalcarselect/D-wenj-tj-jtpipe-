    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-bold mb-4">JTPIPELINE</h3>
            <p className="text-gray-400 mb-4">
              {t('footer.company')}
              Leading supplier of high-quality pipes and fittings worldwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">PE Pipes</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">PVC Pipes</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Pipe Fittings</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Valves</a></li>
          ...
          <div>
            ...
            <address className="not-italic text-gray-400">
              ...
              <p className="mb-2">Phone: +86 1234567890</p>
              <p className="mb-2">Email: info@jtpipeline.com</p>
            </address>
          </div>
        </div>
